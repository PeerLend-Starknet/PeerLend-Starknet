...
const Explore = () => {
  return (
    <main>
        ...
        <div className='w-[100%'>
        <p className='lg:w-[80%] md:w-[80%] w-[100%] font-[400]'>Browse through diverse requests, evaluate the details, and as a lender choose the ones you want to fund. It&apos;s an easy way to find and support borrowers on PeerLend..</p>
